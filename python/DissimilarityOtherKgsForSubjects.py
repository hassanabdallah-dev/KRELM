...
def dissMeasure():
    ...
    for kg in all_kgs:
        ...
        + "FROM properties_subjects_fictive_statistics" \
        + " where kg = '"+kg+"'"
        ...
        for Property in all_properties:
            ...
            + " where b.property = '" + str(Property) + "' and b.type = 'out' and b.kg = '"+kg+"') c " \
            + " where a.property = '" + str(Property) + "' and a.type = 'out' and a.kg = '"+kg+"' " \
            + " ORDER BY degree ASC;"
            mycursor.execute(query)
            result = mycursor.fetchall()
            for x in result:
            ...
            + " FROM properties_subjects_fictive_statistics a " \
            ...
            update = "INSERT INTO properties_subjects_characteristics (property, kg, kullback, d_statistics, jensenshannon) VALUES" \
            ...
            insert = "INSERT INTO subjects_data_for_visualization (property, degree, count, probabilityOfOccuence, type_of_data, kg) VALUES "
            for key, value in sortedReal.items():

...
public class MainSubjects {
	...
	public static void main(String... args) {
	    ...
	    /*long heapSizeInMB = 27 * 1024;
        String heapSizeOption = "-Xmx" + heapSizeInMB + "m";
        System.setProperty("java.vm.args", heapSizeOption);
	...
	public static void generateFictiveStatisticsFile() {
		...
		{	
			...
			for(String s : allProperty) {
				...
				/*if(s.equals("4703_wikiPageWikiLink") == false) {
					continue;
				}*/

package OtherKgReverseAttachment;
import Database.*;
...
public class MainObjects {
	...
	public static void main(String... args) {
		...
		DbConnect.dbname = "graphbipartiteallkgreverseattachment";
	...
	public static void generateFictiveStatisticsFile() {
		...
		{	
			...
			query = "SELECT  distinct property FROM properties_objects_fictive_statistics"
					+ " where kg = '"+ kg +"';";
			...
			for(String s : allProperty) {
				...
				/*if(kg.equals("DBNARY") == false || s.equals("ontolex#sense") == false) {
					continue;
				}*/
				...
				//if(factNumber1 == factNumber2) {
					...
					Runnable graph = new BipartiteGraphObjects(s, factNumber1, subjectNumber, objectNumber, operations, propertyNumber, kg);
